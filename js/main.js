...
/*
    ...
    Rotate by Day of Week: Use HTML/CSS & JavaScript to create a single page that rotates unique colors and content 
    for each weekday (Sunday to Saturday) into the page.The content must include:
...
switch(myDay){
    ...
    case 4:
        ...
        coffee = {
            ...
            name: "drip",
            pic: "drip.jpg",
            alt: "A picture of black coffee",
            day: "Thursday",
            desc: `Black coffee for a strong day!`,
        };
    break;
    ...
    case 5:
        ...
        coffee = {
            ...
            day: "Friday",
            desc: `Frappaccino for the whip cream!`,
        };
    break;
    ...
    case 6:
        ...
        coffee = {
            ...
            day: "Saturday",
            desc: `Mocha for the leaf on top`,
        };
    break;
    ...
    case 0:
        ...
        coffee = {
            ...
            day: "Sunday",
            desc: `Pumpkin Spice Latte so that Fall never ends!`,
        };
    break;
